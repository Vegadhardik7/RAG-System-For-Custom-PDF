...
### Example Interaction
**Scenario**: A user uploads a PDF of the Constitution of India.
...
![Streamlit Interface](path/to/streamlit_interface.png)

![Sample Question and Answer](path/to/sample_qa.png)
...
**RAG-PDF-QA Answer**: [Insert RAG model answer here]

**Direct Gemini Answer**: [Insert direct Gemini answer here]

![Comparison Output](path/to/comparison_output.png)
